...
Classes:
    Xl: A class to handle Excel file operations, including reading sheets, converting data,
    and retrieving specific rows.

Methods:
    __init__(self, file_path, header=0):
        Initializes the `Xl` object by loading all sheets from the specified Excel file into a
...
class Xl:
    """
    The Xl class is used to interact with Excel files, providing methods to load and manipulate
    data from Excel sheets into pandas DataFrames.
    ...
    def __init__(self, file_path, header=0):
        """
        Initializes the Xl object by reading all sheets from the specified Excel file
