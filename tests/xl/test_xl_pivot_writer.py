...
def test_create_criterion_pivots(xl_pivot_writer_instance, sample_data):
    ...
    """
    criterion_pivots, criteria = xl_pivot_writer_instance.create_criterion_pivots(sample_data)
    ...
    assert pivot_table.shape == (1, 2)  # Criterion 1 has 2 rows and 2 columns (data_1)

def test_process_formula(xl_pivot_writer_instance, sample_data, sample_pivot_info):
    """
    ...
    formula = "3*4"
    result_df = xl_pivot_writer_instance.process_formula(criterion_pivots, criteria, formula)
