...
from empty_project import set_project_database, main
...
@patch('empty_project.check_path')
@patch('empty_project.project')
@patch('empty_project.set_project_database')
@patch('empty_project.DB_Loader')
@patch('empty_project.sys.exit')
